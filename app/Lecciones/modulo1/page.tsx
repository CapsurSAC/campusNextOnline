  ...
  return (
    <div className="text-white">
      <h2 className="text-2xl font-bold mb-4 flex items-center gap-2">
        <FiBook size={24} />
        Bienvenido al Módulo 1: Fundamentos del Inglés
      </h2>

      <div className="bg-white/10 p-6 rounded-xl space-y-4 shadow backdrop-blur">
        <p className="text-white/80">
          Este módulo te introducirá al inglés desde lo más básico. Aprenderás saludos, presentaciones, vocabulario esencial y estructuras fundamentales.
        </p>
