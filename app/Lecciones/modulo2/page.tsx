  ...
  return (
    <div className="text-white">
      <h2 className="text-2xl font-bold mb-4 flex items-center gap-2">
        <FiBook size={24} />
        Bienvenido al MÓDULO 2: Rutinas y Tiempo
      ...
      <div className="bg-white/10 p-6 rounded-xl space-y-4 shadow backdrop-blur">
        ...
        <p className="text-white/80">
          En este módulo explorarás el presente simple, el uso del verbo “to be”, rutinas diarias y cómo construir oraciones afirmativas, negativas e interrogativas en inglés.
        </p>
